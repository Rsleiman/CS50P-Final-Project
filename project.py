...
└───────────┘"
    ...
    def suit(self, value:str):
        ...
        elif value.lower()[:-1] in Card.SUITS_ASCII and value.lower()[-1] == "s": # Testing for match with valid plural
    ...
    def rank(self, value):
        ...
        elif value.lower()[:-1] in Card.RANKS_ASCII and value.lower()[-1] == "s": # Testing for match with valid plural
...
class CardGame:
    ...
    def reset(self):
        ...
        # # SMALLER DECK FOR TESTING PURPOSES:
